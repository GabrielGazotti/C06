...
public class Main {
    ...
    public static Computador criarPromocao1() {
        ...
        Computador pc = new Computador("Apple", 473, so, musb);
    ...
    public static Computador criarPromocao2() {
        ...
        MemoriaUSB musb = new MemoriaUSB("Pen-drive", 32);
        Computador pc = new Computador("Samsung", 473+1234, so, musb);
    ...
    public static Computador criarPromocao3() {
        ...
        MemoriaUSB musb = new MemoriaUSB("HD Externo", 1000);
        Computador pc = new Computador("Dell", 473+5678, so, musb);
